...
builder.Services.AddDbContext<AppDbContext>(opt => opt.UseSqlServer(builder.Configuration.GetConnectionString("ResultConnection")));
...
app.MapPost("api/v1/products", async (AppDbContext context, ListingRequest listingRequest) =>{
    ...
    listingRequest.EstimatedCompetionTime = "2023-03-24:10:00:00";
...
app.MapGet("api/v1/productstatus/{requestId}", (AppDbContext context, string requestId) => {
    ...
    listingStatus.EstimatedCompetionTime = "2023-03-24:10:30:00";
